...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.opt_syringe_id = tk.OptionMenu(self, self.syringe_var, "250uL", "1000uL", "5mL - Fischerbrand", "5mL - Omnifix")
    ...
    def generate_gcode(self):
        try:
            ...
            elif syringe_id == "5mL - Omnifix":
                syringe_diameter = 12.35
            else:  # 5mL - Fischerbrand
